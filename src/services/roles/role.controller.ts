...
import RoleDao from "../../models/roles/role.dao";
import CreateRoleDto from "../../models/roles/role.dto";
import PermissionDto from "../../models/permissions/permission.dto";

/**
 * Handles Role routes for RESTful interface
 */
class EngineersRoleController implements Controller {
...
export default EngineersRoleController;
